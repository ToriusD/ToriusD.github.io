...
class GaleryBlock extends Block {
  constructor(value, options) {
    super('galery', value, options)
  }
  toHTML() {
    const styles = this.options
    return row(galeryitems(), css(styles))
  }
}
...
const model = [
  ...
  new NavigationBlock([
    alink('#carouselIndicators2','   Популярное',link_nav),
    alink('#','Книги',link_nav),
  ...
  // new TextBlock('Государственное учреждение культуры «Централизованная библиотечная система г.Новополоцка» (далее ЦБС) включает семь библиотек, из них две детские и три семейного типа.', {
  //   styles: {
  ...
  new ColumnBlock([ 
    alink('#', imageitem(text_image_m, 'align-self-center rounded pb-5', 'width: 15em')),
    alink('#', imageitem(text_image_m, 'align-self-center rounded pb-5', 'width: 15em')),
    alink('#', imageitem(text_image_m, 'align-self-center rounded pb-5', 'width: 15em')),
    alink('#', imageitem(text_image_m, 'align-self-center rounded pb-5', 'width: 15em')),
    alink('#', imageitem(text_image_m, 'align-self-center rounded pb-5', 'width: 15em')),
  ...
  new ColumnBlock([
    col(row(imageitem('https://168856.lp.tobiz.net/img/240x240/f9f419770611675183017e4aadd38279.jpg', 'align-self-center rounded-circle', 'width: 15em'),'justify-content: center') + row('Стивен Кинг','justify-content: center')),
    col(row(imageitem('https://1.bp.blogspot.com/-K2s_OpOI8b0/XxDxjnC5_eI/AAAAAAAAThI/vTEg_6Ypqr8vwMqn1CHOX4wF_48ueQr4gCLcBGAsYHQ/s1600/%25D0%25A8%25D0%25BE%25D0%25BB%25D0%25BE%25D1%2585%25D0%25BE%25D0%25B21.jpg', 'align-self-center rounded-circle', 'width: 15em'),'justify-content: center') + row('Михаил Шолохов','justify-content: center')),
    col(row(imageitem('https://168856.lp.tobiz.net/img/240x240/b9b33de3baa6cae2d8104bf508d2d4a2.jpg', 'align-self-center rounded-circle', 'width: 15em'),'justify-content: center') + row('Брайан Джейкс','justify-content: center'))
  ], {
      styles: {
        color: '#000',
        'text-align':'center',
  ...
  new ColumnBlock([
    alink('#', 'Год мира и созидания'),
    alink('#', 'Время.События.Люди'),
    alink('#', 'Центр правовой информации'),
    alink('#', 'Новополоцк молодежная столица 2023')
  ], {
      styles: {
        padding: '2% 20% 5% 20%',
        'background-color': 'rgb(94, 159, 255)',
  ...
  new TextBlock('Рассказываем о наиболее популярных новостях из мира литературы', {
      styles: {
        'text-align': 'center',
        'padding-bottom': '1em',
        'font-size': '1em',
  ...
  new IMGColBlock([
    mediaContentItem('Новость 1', 'В Год мира и созидания в Новополоцке ко Дню Победы централизованная библиотечная система (далее ЦБС) города проводит 2-й открытый городской конкурс чтецов поэзии «Войны победная строка» (см. Положение). Организаторами конкурса, кроме ЦБС, являются Новополоцкий городской исполнительный комитет, Новополоцкая организация республиканского объединения «Белая Русь».', '20.20.2000', text_image_m, '#'),
    mediaContentItem('Новость 2', '21 апреля в детской библиотеке им.С.Маршака прошла литературная игра-викторина «Сказки дедушки Корнея». Гостями мероприятия стали учащиеся 1«В» класса СШ №4, которые совершили путешествие в волшебную сказочную страну, где живут добрые сказки Корнея Ивановича Чуковского. Ребята познакомились с биографией писателя, узнали много интересных эпизодов из его жизни, о том, как были написаны некоторые из его сказок.', '20.20.2000', text_image_m, '#'),
    mediaContentItem('Новость 3', '20 апреля в клубе ”Оранжевое настроение“ библиотеки им.К.Симонова состоялся час здоровья, который был посвящен привычкам, как вредным, так и полезным. Заседание клуба прошло азартно и весело. Молодые люди выполняли творческие задания (нарисуй ”Портрет никотина“, ”Плохой, хороший аппетит“, ”Твоя витаминная азбука”).', '20.20.2000', text_image_m, '#'),
    mediaContentItem('Новость 4', 'Центральная библиотека им.В.Маяковского удивляет читателей и посетителей уникальностью художественного оформления своих залов. Стены читальных залов библиотеки оформлены фризом «История и преемственность культур», созданным новополоцкими художниками В.Шаппо и В.Гавазюком. Фриз, как элемент интерьера залов библиотеки, привлекает внимание будущих специалистов по дизайну, студентов Полоцкого государственного университета (ПГУ).', '20.20.2000', text_image_m, '#'),
    mediaContentItem('Новость 5', 'Паэтка, член Саюза пісьменнікаў Беларусі, удзельнік народнага калектыву “Крылы” дзяржаўнай установы культуры “Цэнтралізаваная бібліятэчная сістэма горада Наваполацка” Іна Васільеўна Саламаха, якая добра вядома ў літаратурных колах пад псеўданімам – Іна Мароз, стала лаўрэатам 3-й ступені Міжнароднага літаратурнага конкурсу “Славянскі калейдаскоп” у намінацыі “Паэзія”.', '20.20.2000', text_image_m, '#'),
    mediaContentItem('Новость 6', 'Вот уже двадцать один год, находясь в стремительном и дерзновенном полёте мыслей, образов, вдохновения, осуществляет свою деятельность литературно-музыкальное объединение «Крылья» централизованной библиотечной системы города Новополоцка под чутким и бессменным руководством Галины Сташкевич. 16 апреля 2002 года было создано объединение, а в 2005 году уже удостоено звания «народный коллектив».', '20.20.2000', text_image_m, '#'),
    mediaContentItem('Новость 7', '19 апреля в детской библиотеке им. С.Маршака прошла познавательная игра «Азбука безопасности», в которой поучаствовали воспитанники старших групп детского сада №30. Ребята узнали о том, что огонь может быть одновременно другом и врагом, познакомились с историей возникновения и становления пожарной службы.', '20.20.2000', text_image_m, '#')
  ], {
      styles: {
        background: '#fff',
        //width: '10%',
...
function mediaContentItem(name = '', content = '', time = '', img = '', a_link = '', classes = '') {
  return alink(a_link, 
...
function imageitem(img_link, img_Type, styles = '', alt = 'Generic placeholder image') {
  return `<img src="${img_link}" class="${img_Type}" style="${styles}", alt="${alt}">`
}
          ...
          <div class="carousel-caption d-none d-md-block">
            <div class="w-100 hello_world" style="z-index: 999">
              <div class="row">
                <div class="col-12 text-center"><a href="http://86.57.171.98:8080/alis/StartEK/index.php">
                  <h1 class="display-1 text-light">Добро пожаловать</h1>
                  <button id="btn_03" class="btn btn-primary my-3 py-3 px-3 btn-lg">Найти книгу в нашем каталоге</button>
                  </a></div>
              </div>
            </div>
          ...
          <div class="carousel-caption d-none d-md-block">
            <div class="w-100 hello_world" style="z-index: 999">
              <div class="row">
                <div class="col-12 text-center"><a href="http://86.57.171.98:8080/alis/StartEK/index.php">
                  <h1 class="display-1 text-light">Добро пожаловать</h1>
                  <button id="btn_04" class="btn btn-primary my-3 py-3 px-3 btn-lg">Найти книгу в нашем каталоге</button>
                </a></div>
              </div>
            </div>
...
function galeryitems(styles = '') {
  return `
    <div id="galery" class="container-fluid py-3" style="${styles}">

    <div class="container">
    
        <h1 class="fw-light text-center text-lg-start mt-4 my-5">Наша галерея</h1>
        
        <div class="row text-center text-lg-start">
      
          <div class="col-lg-3 col-md-4 col-6">
            <a href="#" class="d-block mb-4 h-100">
              <img class="img-fluid" src="${text_image_m}" alt="">
            </a>
          </div>
          <div class="col-lg-3 col-md-4 col-6">
            <a href="#" class="d-block mb-4 h-100">
...
// document.getElementById('btn_02').onclick = () => showModal('', '', "", "", () => {
//   console.log('Всё работает');
// });
// document.getElementById('btn_03').onclick = () => showModal('', '', "", "", () => {
//   console.log('Всё работает');
// });
// document.getElementById('btn_04').onclick = () => showModal('', '', "", "", () => {
//   console.log('Всё работает');
// });

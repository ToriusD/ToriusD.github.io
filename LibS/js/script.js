...
const model = [
  ...
  new TextBlock(
    `<div class="container justify-content-center mx-auto text-center"><a class="btn btn-primary btn-lg mx-auto text-center" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">Государственное учреждение культуры «ЦБС г.Новополоцка» включает семь библиотек</a>
...
function newsblock() {
  return `
      <form class="px-2 pb-5 w-100">
        ...
        <div class="form-group w-100">
          <input class="form-control form-control" name="content" placeholder="текст">
        </div>
        <div class="form-group w-100">
